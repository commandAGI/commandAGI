...
from commandLAB.processors.screen_parser.types import ParsedScreenshot
from commandLAB.processors.screen_parser.pytesseract_screen_parser import parse_screenshot as parse_with_tesseract
from commandLAB.processors.screen_parser.screenparse_ai_screen_parser import parse_screenshot as parse_with_screenparse_ai
...
class GridOverlayWrapper(BaseComputerEnv):
    ...
    def __init__(
        ...
        if screen_parser == 'tesseract':
            ...
            if not screenparse_ai_key:
                raise ValueError("screenparse_ai_key is required when using screenparse_ai parser")
    ...
    def step(self, action: ComputerAction) -> tuple[ComputerObservation, float, bool, dict]:
