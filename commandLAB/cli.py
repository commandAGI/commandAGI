...
def grid_overlay(
    ...
    if not processors_available:
        typer.echo(
            "Error: Processors module not available. Install with: pip install commandlab[processors]"
        )
        return
...
def ocr(
    ...
    if not processors_available:
        typer.echo(
            "Error: Processors module not available. Install with: pip install commandlab[processors,pytesseract]"
        )
        return
...
def daemon(
    ...
    try:
        ...
        typer.echo(
            "Error: Daemon module not available. Install with: pip install commandlab[daemon]"
        )
    except Exception as e:
        typer.echo(f"Error: {e}")
...
def run_gym(
    ...
    if not gym_available:
        typer.echo(
            "Error: Gym module not available. Install with: pip install commandlab[gym]"
        )
        return
