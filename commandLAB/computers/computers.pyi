...
class LocalComputer(BaseComputer):
    ...
    def start_jupyter_server(self, port: int = 8888, notebook_dir: Optional[str] = None) -> bool: ...
    
    def stop_jupyter_server(self) -> bool: ...
    
    def create_shell(self, executable: str = ..., cwd: Optional[Union[str, Path]] = None, env: Optional[Dict[str, str]] = None) -> LocalShell: ...
...
class VNCComputer(BaseComputer):
    ...
    def start_jupyter_server(self, port: int = 8888, notebook_dir: Optional[str] = None) -> bool: ...
    def stop_jupyter_server(self) -> bool: ...
    def create_shell(self, executable: str = ..., cwd: Optional[Union[str, Path]] = None, env: Optional[Dict[str, str]] = None) -> BaseShell: ...
    @property
    def video_stream_url(self) -> str: ...
    def start_video_stream(self) -> bool: ...
    def stop_video_stream(self) -> bool: ...
