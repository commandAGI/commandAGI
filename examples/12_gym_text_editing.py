#!/usr/bin/env python3
"""
commandAGI Gym Text Editing Example

This example demonstrates how to use the commandAGI gym framework to automate a text editing task.
...
class TextEditingEnv(ComputerEnv):
    ...
    def __init__(self, config: ComputerEnvConfig):
        ...
        self.task_description = (
            "Open a text editor, type 'Hello, commandAGI!', and save the file."
        )
    ...
    def get_reward(self, action: ComputerAction) -> float:
        ...
        if action.type is not None:
            ...
            if "Hello, commandAGI!" in action.type.text:
                reward += 2.0
...
def main():
    print("commandAGI Gym Text Editing Example")
    print("===================================")
    print("This example demonstrates how to use the commandAGI gym framework")
    print("to automate a text editing task.")
    print()
    print("Task: Open a text editor, type 'Hello, commandAGI!', and save the file.")
    print()
