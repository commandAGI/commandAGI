...
""")
        ...
        result = computer.execute_command(CommandAction(
            command=f"{editor_cmd} {script_path}",
            timeout=10
        ))
        ...
        computer.execute_keyboard_hotkey(KeyboardHotkeyAction(
            keys=[KeyboardKey.CTRL, KeyboardKey.END]
        ))
        time.sleep(0.5)
...
"""
        ...
        computer.execute_keyboard_hotkey(KeyboardHotkeyAction(
            keys=[KeyboardKey.CTRL, KeyboardKey.HOME]
        ))
        time.sleep(0.5)
        
        # Search for "def main"
        computer.execute_keyboard_hotkey(KeyboardHotkeyAction(
            keys=[KeyboardKey.CTRL, KeyboardKey.F]
        ))
        time.sleep(0.5)
        ...
        computer.execute_type(TypeAction(
            text="    print(f\"The sum of 5 and 7 is {calculate_sum(5, 7)}\")"
        ))
        time.sleep(1)
