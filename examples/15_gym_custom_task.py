#!/usr/bin/env python3
"""
commandAGI Gym Custom Task Example

This example demonstrates how to create and use a custom task with the commandAGI gym framework.
...
try:
    ...
    from commandAGI.gym.tasks.computer_task import ComputerTaskMixin
...
def main():
    print("commandAGI Gym Custom Task Example")
    print("==================================")
    print("This example demonstrates how to create and use a custom task")
    print("with the commandAGI gym framework.")
    print()
