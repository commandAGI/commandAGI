...
def main():
    ...
    provisioner = DockerProvisioner(
        ...
        container_name="commandlab-web-automation",
    ...
    try:
        ...
        computer.shell(command="firefox --headless --screenshot /tmp/screenshot.png https://example.com")
        time.sleep(2)
...
def perform_web_search(computer, search_engine="https://www.google.com", query="CommandLAB automation"):
    ...
    print(f"Screenshot before search saved to: {screenshot_before.path if screenshot_before and screenshot_before.path else 'N/A'}")
    ...
    if displays and displays.displays:
        ...
        print(f"Screenshot after search saved to: {screenshot_after.path if screenshot_after and screenshot_after.path else 'N/A'}")
        ...
        print(f"Screenshot after scrolling saved to: {screenshot_scrolled.path if screenshot_scrolled and screenshot_scrolled.path else 'N/A'}")
