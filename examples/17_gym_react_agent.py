#!/usr/bin/env python3
"""
commandAGI Gym React Agent Example

This example demonstrates how to use the commandAGI gym framework with the ReactComputerAgent.
...
def main():
    print("commandAGI Gym React Agent Example")
    print("==================================")
    print(
        "This example demonstrates how to use the commandAGI gym framework with the ReactComputerAgent."
    )
