"""
Utility functions for commandAGI documentation macros.
"""
...
def generate_single_page_api_docs():
    ...
    This function scans the commandAGI codebase and generates a single Markdown page
    ...
    content = "# commandAGI API Reference\n\n"
    content += "This page contains the complete API reference for commandAGI.\n\n"
