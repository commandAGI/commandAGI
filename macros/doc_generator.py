...
def generate_api_docs():
    ...
    for root, dirs, files in os.walk(base_dir):
        ...
        for file in files:
            if file.endswith(".py") and not file.startswith("__"):
                ...
                rel_dir_path = rel_dir_path.replace("\\", "/")  # Normalize path separators
                if rel_dir_path == ".":
                    rel_dir_path = ""
    ...
    if not main_index_path.exists():
        ...
        main_index_content = "# CommandLAB API Reference\n\n"
        main_index_content += "This section contains the API reference for CommandLAB.\n\n"
