...
class BaseKicad(BaseApplication):
    ...
    # Project Management
    def create_project(self, project_path: Union[str, Path], 
    ...
    # Library Management
    def add_library(self, lib_path: Union[str, Path], lib_type: Literal["symbol", "footprint"]) -> bool:
    ...
    def place_component_schematic(self, component_id: str, 
    ...
    def add_bus(self, start: Tuple[float, float],
               end: Tuple[float, float],
    ...
    def add_net_label(self, position: Tuple[float, float], 
                     name: str,
    ...
    def add_power_symbol(self, position: Tuple[float, float],
                        power_type: str) -> bool:
    ...
    def add_hierarchical_sheet(self, position: Tuple[float, float],
    ...
    def update_pcb_from_schematic(self, mode: Literal["update", "rebuild"] = "update") -> bool:
    ...
    def place_component_pcb(self, component_id: str, 
                          position: Tuple[float, float],
                          layer: str,
                          rotation: float = 0,
                          side: Literal["top", "bottom"] = "top") -> bool:
    ...
    def route_track(self, points: List[Tuple[float, float]], 
                   net_name: str,
                   layer: str,
                   width: float,
                   via_config: Optional[Dict[str, Any]] = None) -> bool:
    ...
    def add_via(self, position: Tuple[float, float],
                net_name: str,
                size: float,
                drill: float,
                layers: Tuple[str, str]) -> bool:
    ...
    def add_dimension(self, start: Tuple[float, float],
                     end: Tuple[float, float],
                     layer: str) -> bool:
    ...
    def run_length_tuning(self, nets: List[str],
                         target_length: float,
    ...
    def export_gerber(self, output_dir: Union[str, Path],
    ...
    def export_drill_files(self, output_dir: Union[str, Path],
    ...
    def export_bom(self, output_path: Union[str, Path],
                  format: str = "csv",
                  grouping: Optional[List[str]] = None) -> bool:
    ...
    def export_position_file(self, output_path: Union[str, Path],
                           format: str = "csv") -> bool:
    ...
    # 3D Visualization
    def export_step(self, output_path: Union[str, Path],
    ...
    def render_3d(self, output_path: Union[str, Path],
                 view: Dict[str, Any]) -> bool:
