...
class TestGridOverlay(unittest.TestCase):
    ...
    def test_overlay_grid_with_odd_dimensions(self):
        ...
        self.assertEqual(result.getpixel((50, 25)), (255, 0, 0))  # Vertical line at x=50
        self.assertEqual(result.getpixel((100, 25)), (255, 0, 0))  # Vertical line at x=100
    ...
    def test_overlay_grid_with_small_image(self):
        ...
        self.assertEqual(result.getpixel((15, 0)), (255, 0, 0))  # Horizontal line at y=0
