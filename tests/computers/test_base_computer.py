...
class TestBaseComputer(unittest.TestCase):
    ...
    def test_execute_keyboard_key_press(self):
        ...
        with patch.object(self.computer, 'execute_keyboard_key_down') as mock_key_down, \
             patch.object(self.computer, 'execute_keyboard_key_release') as mock_key_release, \
    ...
    def test_execute_keyboard_keys_press(self):
        ...
        with patch.object(self.computer, 'execute_keyboard_keys_down') as mock_keys_down, \
             patch.object(self.computer, 'execute_keyboard_keys_release') as mock_keys_release:
            
            action = KeyboardKeysPressAction(keys=[KeyboardKey.CTRL, KeyboardKey.C], duration=0.5)
    ...
    def test_execute_keyboard_keys_release(self):
        ...
        with patch.object(self.computer, 'execute_keyboard_key_release') as mock_key_release:
    ...
    def test_execute_type(self):
        ...
        with patch.object(self.computer, 'execute_keyboard_key_press') as mock_key_press:
    ...
    def test_execute_click(self):
        ...
        with patch.object(self.computer, 'execute_mouse_move') as mock_mouse_move, \
             patch.object(self.computer, 'execute_mouse_button_down') as mock_button_down, \
             patch.object(self.computer, 'execute_mouse_button_up') as mock_button_up, \
             patch('time.sleep') as mock_sleep:
            
            action = ClickAction(x=100, y=200, move_duration=0.5, press_duration=0.3, button=MouseButton.LEFT)
    ...
    def test_execute_double_click(self):
        ...
        with patch.object(self.computer, 'execute_click') as mock_click, \
             patch('time.sleep') as mock_sleep:
    ...
    def test_execute_drag(self):
        ...
        with patch.object(self.computer, 'execute_mouse_move') as mock_mouse_move, \
            ...
            self.assertEqual(move_args[0][1], {'x': 100, 'y': 200, 'move_duration': 0.5})
            self.assertEqual(move_args[1][1], {'x': 300, 'y': 400, 'move_duration': 0.5})
