...
class TestDaemonClientComputer(unittest.TestCase):
    ...
    def test_get_keyboard_state(self):
        ...
        self.mock_requests.get.assert_called_with(
            "http://localhost:8000/keyboard/state"
        )
    ...
    def test_execute_command(self):
        ...
        self.mock_requests.post.assert_called_with(
            "http://localhost:8000/command", json=command.model_dump()
        )
    ...
    def test_execute_keyboard_key_down(self):
        ...
        # Check that requests.post was called with the correct URL and data
        self.mock_requests.post.assert_called_with(
            "http://localhost:8000/keyboard/key/down", json=action.model_dump()
        )
    ...
    def test_execute_keyboard_key_release(self):
        ...
        # Check that requests.post was called with the correct URL and data
        self.mock_requests.post.assert_called_with(
            "http://localhost:8000/keyboard/key/release", json=action.model_dump()
        )
    ...
    def test_execute_mouse_move(self):
        ...
        # Check that requests.post was called with the correct URL and data
        self.mock_requests.post.assert_called_with(
            "http://localhost:8000/mouse/move", json=action.model_dump()
        )
    ...
    def test_execute_mouse_scroll(self):
        ...
        # Check that requests.post was called with the correct URL and data
        self.mock_requests.post.assert_called_with(
            "http://localhost:8000/mouse/scroll", json=action.model_dump()
        )
    ...
    def test_execute_mouse_button_down(self):
        ...
        # Check that requests.post was called with the correct URL and data
        self.mock_requests.post.assert_called_with(
            "http://localhost:8000/mouse/button/down", json=action.model_dump()
        )
    ...
    def test_execute_mouse_button_up(self):
        ...
        # Check that requests.post was called with the correct URL and data
        self.mock_requests.post.assert_called_with(
            "http://localhost:8000/mouse/button/up", json=action.model_dump()
        )
    ...
    @patch(
        "commandLAB.computers.daemon_client_computer.ProvisioningMethod.get_provisioner_cls"
    )
