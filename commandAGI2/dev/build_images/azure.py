"""Azure VM building functionality for commandAGI2 daemon."""
        ...
        "builders": [
            {
                ...
                "managed_image_resource_group_name": "commandagi2-rg",
                "managed_image_name": "commandagi2-daemon-{{user `version`}}",
                "os_type": "Linux",
