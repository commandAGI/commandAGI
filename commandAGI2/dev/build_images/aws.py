"""AWS AMI building functionality for commandAGI2 daemon."""
...
from commandAGI2.dev.build_images.utils import ensure_packer_template
        ...
        "builders": [
            {
                ...
                "ssh_username": "ubuntu",
                "ami_name": "commandagi2-daemon-{{user `version`}}-{{timestamp}}",
                "ami_description": "commandAGI2 daemon image",
                "tags": {"Name": "commandagi2-daemon", "Version": "{{user `version`}}"},
            }
        ],
        "provisioners": [
            {
                ...
                "inline": [
                    ...
                    "sudo pip3 install commandagi2[local,daemon]=={{user `version`}}",
                ],
            }
        ],
    }
