...
import logging
import sys
from commandAGI2.dev.build_images import cli as build_images_cli
from commandAGI2.dev.update_daemon_client import generate_openapi_client
...
cli = typer.Typer(help="commandAGI2 development tools")
