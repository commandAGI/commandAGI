try:
    ...
    raise ImportError(
        "pytesseract is not installed. Please install commandAGI2 with the pytesseract extra:\n\npip install commandAGI2[pytesseract]"
    )

from commandAGI2.utils.image import b64ToImage
from commandAGI2.processors.screen_parser.types import ParsedScreenshot, ParsedElement
