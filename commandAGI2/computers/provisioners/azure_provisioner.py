...
class AzureProvisioner(BaseComputerProvisioner):
    ...
    def _provision_resource(self) -> None:
        """Provision an Azure VM with the commandAGI2 image"""
        ...
        custom_data = f"""#!/bin/bash
            ...
            python3 -m commandagi2.daemon.daemon --port {self.daemon_port} --token {self.daemon_token} --backend pynput
        """
