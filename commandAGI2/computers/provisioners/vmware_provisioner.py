...
class VMwareProvisioner(BaseComputerProvisioner):
    def __init__(
        self,
        port: int = 8000,
                    ...
                    if self.is_running():
                        ...
                        self._vmrun_command(
                            [
                                ...
                                "vagrant",
                                "/bin/bash",
                                f"pip install commandagi2[local,daemon] && python -m commandagi2.daemon.daemon --port {self.port} --backend pynput",
                            ]
                        )
