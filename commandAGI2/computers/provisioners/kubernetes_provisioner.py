...
class KubernetesProvisioner(BaseComputerProvisioner):
    ...
    This provisioner creates and manages Kubernetes deployments and services for running the commandAGI2 daemon.
    ...
    Args:
        ...
        deployment_prefix: Prefix to use when generating deployment names (default: "commandagi2-daemon")
        service_prefix: Prefix to use when generating service names (default: "commandagi2-daemon-svc")
    ...
    def __init__(
        ...
        deployment_prefix: str = "commandagi2-daemon",
        service_prefix: str = "commandagi2-daemon-svc",
            ...
            try:
                ...
                deployment = client.V1Deployment(
                    ...
                    spec=client.V1DeploymentSpec(
                        ...
                        selector=client.V1LabelSelector(
                            match_labels={"app": "commandagi2-daemon"}
                        ),
                        template=client.V1PodTemplateSpec(
                            metadata=client.V1ObjectMeta(
                                labels={"app": "commandagi2-daemon"}
                            ),
                ...
                service = client.V1Service(
                    ...
                    spec=client.V1ServiceSpec(
                        selector={"app": "commandagi2-daemon"},
