...
try:
    ...
    raise ImportError(
        "The local dependencies are not installed. Please install commandAGI2 with the local extra:\n\npip install commandAGI2[local]"
    )
...
from commandAGI2._utils.image import process_screenshot
from commandAGI2._utils.platform import DEFAULT_SHELL_EXECUTIBLE
...
class LocalShell(BaseShell):
    ...
    def __init__(
        ...
        super().__init__(
            ...
            env=env or {},
            logger=logger or logging.getLogger("commandAGI2.shell"),
        )
