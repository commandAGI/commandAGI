...
from commandAGI2._utils.config import APPDIR, DEV_MODE
from commandAGI2._utils.counter import next_for_cls
...
class BaseComputer(BaseModel):
    ...
    def __init__(self, name=None, **kwargs):
        ...
        # Initialize logger
        self.logger = logging.getLogger(f"commandAGI2.computers.{self.name}")
