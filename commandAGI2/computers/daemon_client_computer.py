...
from commandAGI2._utils.config import APPDIR
from commandAGI2._utils.image import process_screenshot, base64_to_image

# Import the proper client classes
try:
    from commandAGI2.daemon.client import AuthenticatedClient
    from commandAGI2.daemon.client.api.default.execute_command_execute_command_post import (
        sync as execute_command_sync,
    )
    from commandAGI2.daemon.client.api.default.execute_keyboard_key_down_execute_keyboard_key_down_post import (
        sync as execute_keyboard_key_down_sync,
    )
    from commandAGI2.daemon.client.api.default.execute_keyboard_key_release_execute_keyboard_key_release_post import (
        sync as execute_keyboard_key_release_sync,
    )
    from commandAGI2.daemon.client.api.default.execute_keyboard_key_press_execute_keyboard_key_press_post import (
        sync as execute_keyboard_key_press_sync,
    )
    from commandAGI2.daemon.client.api.default.execute_keyboard_hotkey_execute_keyboard_hotkey_post import (
        sync as execute_keyboard_hotkey_sync,
    )
    from commandAGI2.daemon.client.api.default.execute_type_execute_type_post import (
        sync as execute_type_sync,
    )
    from commandAGI2.daemon.client.api.default.execute_mouse_move_execute_mouse_move_post import (
        sync as execute_mouse_move_sync,
    )
    from commandAGI2.daemon.client.api.default.execute_mouse_scroll_execute_mouse_scroll_post import (
        sync as execute_mouse_scroll_sync,
    )
    from commandAGI2.daemon.client.api.default.execute_mouse_button_down_execute_mouse_button_down_post import (
        sync as execute_mouse_button_down_sync,
    )
    from commandAGI2.daemon.client.api.default.execute_mouse_button_up_execute_mouse_button_up_post import (
        sync as execute_mouse_button_up_sync,
    )
    from commandAGI2.daemon.client.api.default.get_observation_observation_get import (
        sync as get_observation_sync,
    )
    from commandAGI2.daemon.client.api.default.get_screenshot_observation_screenshot_get import (
        sync as get_screenshot_sync,
    )
    from commandAGI2.daemon.client.api.default.get_mouse_state_observation_mouse_state_get import (
        sync as get_mouse_state_sync,
    )
    from commandAGI2.daemon.client.api.default.get_keyboard_state_observation_keyboard_state_get import (
        sync as get_keyboard_state_sync,
    )
    from commandAGI2.daemon.client.api.default.reset_reset_post import (
        sync as reset_sync,
    )
    from commandAGI2.daemon.client.api.default.get_video_stream_url_video_stream_url_get import (
        sync as get_video_stream_url_sync,
    )
    from commandAGI2.daemon.client.api.default.start_video_stream_video_start_stream_post import (
        sync as start_video_stream_sync,
    )
    from commandAGI2.daemon.client.api.default.stop_video_stream_video_stop_stream_post import (
        sync as stop_video_stream_sync,
    )
    from commandAGI2.daemon.client.api.default.execute_run_process_execute_run_process_post import (
        sync as run_process_sync,
    )
    from commandAGI2.daemon.client.models import (
    ...
    raise ImportError(
        "commandAGI2 daemon client is not installed. Please install commandAGI2 with the daemon extra:\n\npip install commandAGI2[daemon-client-all] (or one of the other `daemon-client-*` extras)"
    )
